...
HORIZON_WEIGHTS: dict[str, dict[str, float]] = {
    "3m": {
        "agent.technical_risk": 0.10,
        "agent.sentiment_news": 0.10,
        "agent.growth_revisions": 0.07,
        "agent.fundamentals": 0.05,
        "agent.valuation": 0.05,
        "agent.macro_liquidity": 0.05,
        "agent.insider_activity": 0.06,
        "agent.options_flow": 0.05,
        "agent.short_interest": 0.04,
        "agent.earnings_quality": 0.03,
        "agent.credit_risk": 0.05,
        "agent.institutional_flow": 0.04,
        "agent.earnings_surprise": 0.06,
        "agent.price_momentum": 0.08,
        "agent.dividend_quality": 0.02,
        "agent.capital_allocation": 0.02,
        "agent.analyst_consensus": 0.07,
        "agent.financial_distress": 0.04,
        "agent.piotroski": 0.03,
        "agent.industry_competition": 0.01,
        "agent.portfolio_risk": 0.01,
    },
    "6m": {
        "agent.technical_risk": 0.07,
        "agent.sentiment_news": 0.07,
        "agent.growth_revisions": 0.09,
        "agent.fundamentals": 0.08,
        "agent.valuation": 0.08,
        "agent.macro_liquidity": 0.05,
        "agent.insider_activity": 0.04,
        "agent.options_flow": 0.03,
        "agent.short_interest": 0.03,
        "agent.earnings_quality": 0.06,
        "agent.credit_risk": 0.04,
        "agent.institutional_flow": 0.05,
        "agent.earnings_surprise": 0.05,
        "agent.price_momentum": 0.05,
        "agent.dividend_quality": 0.04,
        "agent.capital_allocation": 0.05,
        "agent.analyst_consensus": 0.06,
        "agent.financial_distress": 0.05,
        "agent.piotroski": 0.06,
        "agent.industry_competition": 0.02,
        "agent.portfolio_risk": 0.02,
    },
    "12m": {
        "agent.technical_risk": 0.03,
        "agent.sentiment_news": 0.03,
        "agent.growth_revisions": 0.10,
        "agent.fundamentals": 0.11,
        ...
        "agent.earnings_quality": 0.08,
        "agent.credit_risk": 0.03,
        "agent.institutional_flow": 0.04,
        "agent.earnings_surprise": 0.03,
        "agent.price_momentum": 0.02,
        "agent.dividend_quality": 0.06,
        "agent.capital_allocation": 0.07,
        "agent.analyst_consensus": 0.04,
        "agent.financial_distress": 0.06,
        "agent.piotroski": 0.08,
        "agent.industry_competition": 0.04,
