...
HORIZON_WEIGHTS: dict[str, dict[str, float]] = {
    "3m": {
        ...
        "agent.insider_activity": 0.09,
        "agent.options_flow": 0.08,
        "agent.short_interest": 0.06,
        "agent.earnings_quality": 0.04,
        "agent.credit_risk": 0.08,
    ...
    "12m": {
        "agent.technical_risk": 0.06,
        "agent.sentiment_news": 0.06,
        "agent.growth_revisions": 0.15,
        "agent.fundamentals": 0.17,
