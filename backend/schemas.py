...
HORIZON_WEIGHTS: dict[str, dict[str, float]] = {
    "3m": {
        "agent.technical_risk": 0.18,
        "agent.sentiment_news": 0.18,
        "agent.growth_revisions": 0.11,
    ...
    "6m": {
        "agent.technical_risk": 0.12,
        "agent.sentiment_news": 0.12,
        "agent.growth_revisions": 0.16,
        "agent.fundamentals": 0.13,
        "agent.valuation": 0.13,
    ...
    "12m": {
        ...
        "agent.industry_competition": 0.08,
        "agent.portfolio_risk": 0.04,
    },
}
