...
HORIZON_WEIGHTS: dict[str, dict[str, float]] = {
    "3m": {
        "agent.technical_risk": 0.17,
        "agent.sentiment_news": 0.17,
        ...
        "agent.options_flow": 0.09,
        "agent.short_interest": 0.07,
    ...
    "12m": {
        ...
        "agent.growth_revisions": 0.16,
        "agent.fundamentals": 0.18,
        "agent.valuation": 0.16,
        ...
        "agent.industry_competition": 0.07,
