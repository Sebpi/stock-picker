...
HORIZON_WEIGHTS: dict[str, dict[str, float]] = {
    "3m": {
        "agent.technical_risk": 0.13,
        "agent.sentiment_news": 0.13,
        "agent.growth_revisions": 0.09,
        "agent.fundamentals": 0.07,
        "agent.valuation": 0.07,
        "agent.macro_liquidity": 0.06,
        "agent.insider_activity": 0.08,
        "agent.options_flow": 0.07,
        "agent.short_interest": 0.05,
        "agent.earnings_quality": 0.04,
        "agent.credit_risk": 0.07,
        "agent.institutional_flow": 0.06,
        "agent.earnings_surprise": 0.08,
        "agent.industry_competition": 0.01,
        "agent.portfolio_risk": 0.01,
    },
    "6m": {
        "agent.technical_risk": 0.09,
        "agent.sentiment_news": 0.09,
        ...
        "agent.institutional_flow": 0.07,
        "agent.earnings_surprise": 0.07,
        "agent.industry_competition": 0.04,
        "agent.portfolio_risk": 0.03,
    },
    "12m": {
        "agent.technical_risk": 0.05,
        "agent.sentiment_news": 0.05,
        "agent.growth_revisions": 0.14,
        "agent.fundamentals": 0.16,
        "agent.valuation": 0.14,
        "agent.macro_liquidity": 0.08,
        "agent.insider_activity": 0.04,
        "agent.options_flow": 0.02,
        "agent.short_interest": 0.02,
        "agent.earnings_quality": 0.10,
        "agent.credit_risk": 0.04,
        "agent.institutional_flow": 0.06,
        "agent.earnings_surprise": 0.04,
        "agent.industry_competition": 0.06,
        "agent.portfolio_risk": 0.03,
    },
}
