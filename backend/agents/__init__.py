...
def run_all_agents(ticker: str, run_id: str | None = None) -> dict[str, AgentSignal]:
    ...
    from agents.insider_activity import InsiderActivityAgent
    from agents.options_flow import OptionsFlowAgent
    from agents.short_interest import ShortInterestAgent
    ...
    from agents.analyst_consensus import AnalystConsensusAgent
    from agents.financial_distress import FinancialDistressAgent
